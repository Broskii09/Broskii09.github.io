...
function getDataFromEmployees(containerId) {
  ...
  // Create the image element for the mantel image
const mantelImage = document.createElement('img');
mantelImage.setAttribute('src', 'img/mantel.png'); // Set the path to your mantel image
mantelImage.classList.add('mantel-image'); // Add the mantel-image class


  // Create the image element for the employee's photo
  const img = document.createElement('img');
  img.setAttribute('src', imageUrl);
  img.classList.add('img-fluid', 'img-with-overlay');

  // Add the mantel image to the grid item (before the employee's photo)
  gridItem.appendChild(mantelImage);

  // Add the employee's photo to the grid item (after the mantel image)
